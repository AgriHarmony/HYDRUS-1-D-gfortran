...
plot 'obs_nod_chem11.out' using 3:4 title "        -2.0 cm " linestyle 1   , \
     'obs_nod_chem21.out' using 3:4 title "        -4.0 cm " linestyle 2   , \
     'obs_nod_chem31.out' using 3:4 title "        -6.0 cm " linestyle 3   , \
     'obs_nod_chem41.out' using 3:4 title "        -8.0 cm " linestyle 4   
# EOF