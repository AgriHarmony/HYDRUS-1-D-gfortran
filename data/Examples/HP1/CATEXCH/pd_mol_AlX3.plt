...
set xlabel "AlX3 (mol/kg water)"
set loadpath "C:\ussl\HYDRUS-1D v4\Examples\HP1\CATEXCH\"
plot 'nod_inf_chem.out' using 21:2 index 0:0 title "      0 days " linestyle 1 , \
     'nod_inf_chem.out' using 21:2 index 1:1 title "  0.50 days" linestyle 2 , \
     'nod_inf_chem.out' using 21:2 index 2:2 title "  1.00 days" linestyle 3 , \
     'nod_inf_chem.out' using 21:2 index 3:3 title "  3.00 days" linestyle 4 , \
     'nod_inf_chem.out' using 21:2 index 4:4 title "  9.00 days" linestyle 5 , \
     'nod_inf_chem.out' using 21:2 index 5:5 title " 15.00 days" linestyle 6 
