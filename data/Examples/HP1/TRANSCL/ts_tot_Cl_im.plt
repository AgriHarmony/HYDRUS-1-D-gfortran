...
set ylabel "Total concentration of Cl (mol/kg water)"
set loadpath "C:\ussl\HYDRUS-1D v4\Examples\HP1\TRANSCL\"
plot 'obs_nod_chem26im.out' using 3:6 title "       -25.0 cm " linestyle 1   , \
     'obs_nod_chem51im.out' using 3:6 title "       -50.0 cm " linestyle 2   , \
     'obs_nod_chem76im.out' using 3:6 title "       -75.0 cm " linestyle 3   , \
     'obs_nod_chem101im.out' using 3:6 title "      -100.0 cm " linestyle 4   
# EOF