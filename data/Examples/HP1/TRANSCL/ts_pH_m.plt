...
plot 'obs_nod_chem26m.out' using 3:4 title "       -25.0 cm " linestyle 1   , \
     'obs_nod_chem51m.out' using 3:4 title "       -50.0 cm " linestyle 2   , \
     'obs_nod_chem76m.out' using 3:4 title "       -75.0 cm " linestyle 3   , \
     'obs_nod_chem101m.out' using 3:4 title "      -100.0 cm " linestyle 4   
# EOF