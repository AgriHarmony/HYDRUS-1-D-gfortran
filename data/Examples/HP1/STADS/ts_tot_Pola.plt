...
set ylabel "Total concentration of Pola (mol/kg water)"
set loadpath "C:\ussl\HYDRUS-1D v4\Examples\HP1\STADS\"
plot 'obs_nod_chem51.out' using 3:6 title "       -50.0 cm " linestyle 1   , \
     'obs_nod_chem101.out' using 3:6 title "      -100.0 cm " linestyle 2   
# EOF