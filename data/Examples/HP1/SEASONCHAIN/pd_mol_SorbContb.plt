...
set xlabel "SorbContb (mol/kg water)"
...
plot 'nod_inf_chem.out' using 13:2 index 0:0 title "      0 days " linestyle 1 , \
     'nod_inf_chem.out' using 13:2 index 1:1 title "250.00 days" linestyle 2 , \
     'nod_inf_chem.out' using 13:2 index 2:2 title "500.00 days" linestyle 3 , \
     'nod_inf_chem.out' using 13:2 index 3:3 title "1000.00 days" linestyle 4 , \
     'nod_inf_chem.out' using 13:2 index 4:4 title "1095.00 days" linestyle 5 
