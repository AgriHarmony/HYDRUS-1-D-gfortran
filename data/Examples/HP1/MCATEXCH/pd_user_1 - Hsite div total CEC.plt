...
set xlabel "1 - Hsite div total CEC ()"
set loadpath "C:\ussl\HYDRUS-1D v4\Examples\HP1\MCATEXCH\"
plot 'nod_inf_chem.out' using 7:2 index 0:0 title "      0 yearss " linestyle 1 , \
     'nod_inf_chem.out' using 7:2 index 1:1 title "  0.30 yearss" linestyle 2 , \
     'nod_inf_chem.out' using 7:2 index 2:2 title "  0.50 yearss" linestyle 3 , \
     'nod_inf_chem.out' using 7:2 index 3:3 title "  0.70 yearss" linestyle 4 , \
     'nod_inf_chem.out' using 7:2 index 4:4 title "  1.00 yearss" linestyle 5 
