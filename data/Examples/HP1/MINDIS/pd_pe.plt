...
plot 'nod_inf_chem.out' using 5:2 index 0:0 title "      0 days " linestyle 1 , \
     'nod_inf_chem.out' using 5:2 index 1:1 title "  2.00 days" linestyle 2 , \
     'nod_inf_chem.out' using 5:2 index 2:2 title "  4.00 days" linestyle 3 , \
     'nod_inf_chem.out' using 5:2 index 3:3 title "  8.00 days" linestyle 4 , \
     'nod_inf_chem.out' using 5:2 index 4:4 title " 15.00 days" linestyle 5 , \
     'nod_inf_chem.out' using 5:2 index 5:5 title " 25.00 days" linestyle 6 , \
     'nod_inf_chem.out' using 5:2 index 6:6 title " 50.00 days" linestyle 7 , \
     'nod_inf_chem.out' using 5:2 index 7:7 title "100.00 days" linestyle 8 , \
     'nod_inf_chem.out' using 5:2 index 8:8 title "150.00 days" linestyle 9 
