...
set ylabel "gibbsite (mol/1000 cm³ of soil)"
set loadpath "C:\ussl\HYDRUS-1D v4\Examples\HP1\MINDIS\"
plot 'obs_nod_chem51.out' using 3:9 title "       -50.0 cm " linestyle 1   , \
     'obs_nod_chem101.out' using 3:9 title "      -100.0 cm " linestyle 2   
# EOF